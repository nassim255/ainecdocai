                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="space-y-5">
                            <a target={"_blank"} href={"https://www.instagram.com/ainec.club?igsh=azN5dDExb2pjdjA0"} className="flex items-center space-x-3">
                                <FontAwesomeIcon icon={faInstagram} />
                                <span>ainec.club</span>
                            </a>
                            <a href={"https://www.facebook.com/share/18nMhHLpsp/"} target={"_blank"} className="flex items-center space-x-3">
                                <FontAwesomeIcon icon={faFacebook} />
                                <span>ainec.club</span>
                            </a>
                            <a href={"https://www.linkedin.com/company/ainec-club/"} target={"_blank"} className="flex items-center space-x-3">
